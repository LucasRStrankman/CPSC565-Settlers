...
to setup-patches
 ...
 ask patches [
    ...
    if ((pxcor = -8) and (pycor = 8))  [ set pcolor yellow set probability 4]
    if ((pxcor = -6) and (pycor = 8))  [ set pcolor white set probability 10]
    if ((pxcor = -4) and (pycor = 8))  [ set pcolor orange set probability 2]
    if ((pxcor = -2) and (pycor = 8))  [ set pcolor green set probability 10]
    if ((pxcor = 0) and (pycor = 8))  [ set pcolor yellow set probability 8]
    if ((pxcor = 2) and (pycor = 8))  [ set pcolor yellow set probability 2]
    if ((pxcor = 4) and (pycor = 8))  [ set pcolor green set probability 4]
    if ((pxcor = 6) and (pycor = 8))  [ set pcolor white set probability 8]
    if ((pxcor = 8) and (pycor = 8))  [ set pcolor green set probability 6]

    ;4th row
    if ((pxcor = -8) and (pycor = 6))  [ set pcolor green set probability 9]
    if ((pxcor = -6) and (pycor = 6))  [ set pcolor yellow set probability 0]
    if ((pxcor = -4) and (pycor = 6))  [ set pcolor green set probability 1]
    if ((pxcor = -2) and (pycor = 6))  [ set pcolor yellow set probability 5]
    if ((pxcor = 0) and (pycor = 6))  [ set pcolor yellow set probability 2]
    if ((pxcor = 2) and (pycor = 6))  [ set pcolor green set probability 0]
    if ((pxcor = 4) and (pycor = 6))  [ set pcolor yellow set probability 3]
    if ((pxcor = 6) and (pycor = 6))  [ set pcolor orange set probability 0]
    if ((pxcor = 8) and (pycor = 6))  [ set pcolor orange set probability 10]

    ;5th row
    if ((pxcor = -8) and (pycor = 4))  [ set pcolor white set probability 1]
    if ((pxcor = -6) and (pycor = 4))  [ set pcolor orange set probability 0]
    if ((pxcor = -4) and (pycor = 4))  [ set pcolor green set probability 3]
    if ((pxcor = -2) and (pycor = 4))  [ set pcolor green set probability 10]
    if ((pxcor = 0) and (pycor = 4))  [ set pcolor white set probability 2]
    if ((pxcor = 2) and (pycor = 4))  [ set pcolor orange set probability 9]
    if ((pxcor = 4) and (pycor = 4))  [ set pcolor yellow set probability 8]
    if ((pxcor = 6) and (pycor = 4))  [ set pcolor green set probability 10]
    if ((pxcor = 8) and (pycor = 4))  [ set pcolor yellow set probability 0]

    ;6th row
    if ((pxcor = -8) and (pycor = 2))  [ set pcolor yellow set probability 3]
    if ((pxcor = -6) and (pycor = 2))  [ set pcolor green set probability 4]
    ...
    if ((pxcor = 6) and (pycor = 2))  [ set pcolor orange set probability 5]
    if ((pxcor = 8) and (pycor = 2))  [ set pcolor white set probability 5]

    ;7th row
    if ((pxcor = -8) and (pycor = 0))  [ set pcolor orange set probability 8]
    if ((pxcor = -6) and (pycor = 0))  [ set pcolor orange set probability 0]
    if ((pxcor = -4) and (pycor = 0))  [ set pcolor green set probability 5]
    if ((pxcor = -2) and (pycor = 0))  [ set pcolor brown set probability 7] ;desert tile
    ...
    if ((pxcor = 6) and (pycor = 0))  [ set pcolor green set probability 1]
    if ((pxcor = 8) and (pycor = 0))  [ set pcolor white set probability 8]

    ;8th row
    if ((pxcor = -8) and (pycor = -2))  [ set pcolor green set probability 10]
    if ((pxcor = -6) and (pycor = -2))  [ set pcolor orange set probability 5]
    ...
    if ((pxcor = 2) and (pycor = -2))  [ set pcolor green set probability 1]
    if ((pxcor = 4) and (pycor = -2))  [ set pcolor orange set probability 7]
    if ((pxcor = 6) and (pycor = -2))  [ set pcolor white set probability 0]
    if ((pxcor = 8) and (pycor = -2))  [ set pcolor orange set probability 5]

    ;9th row
    if ((pxcor = -8) and (pycor = -4))  [ set pcolor white set probability 6]
    if ((pxcor = -6) and (pycor = -4))  [ set pcolor green set probability 3]
    ...
    if ((pxcor = 6) and (pycor = -4))  [ set pcolor yellow set probability 4]
    if ((pxcor = 8) and (pycor = -4))  [ set pcolor green set probability 6]

    ;10th row
    if ((pxcor = -8) and (pycor = -6))  [ set pcolor green set probability 4]
    if ((pxcor = -6) and (pycor = -6))  [ set pcolor orange set probability 9]
    if ((pxcor = -4) and (pycor = -6))  [ set pcolor yellow set probability 0]
    if ((pxcor = -2) and (pycor = -6))  [ set pcolor green set probability 1]
    if ((pxcor = 0) and (pycor = -6))  [ set pcolor yellow set probability 0]
    if ((pxcor = 2) and (pycor = -6))  [ set pcolor white set probability 0]
    if ((pxcor = 4) and (pycor = -6))  [ set pcolor yellow set probability 5]
    if ((pxcor = 6) and (pycor = -6))  [ set pcolor green set probability 2]
    if ((pxcor = 8) and (pycor = -6))  [ set pcolor white set probability 2]

    ;11th row
    if ((pxcor = -8) and (pycor = -8))  [ set pcolor green set probability 2]
    if ((pxcor = -6) and (pycor = -8))  [ set pcolor white set probability 10]
    if ((pxcor = -4) and (pycor = -8))  [ set pcolor yellow set probability 8]
    if ((pxcor = -2) and (pycor = -8))  [ set pcolor green set probability 8]
    if ((pxcor = 0) and (pycor = -8))  [ set pcolor white set probability 6]
    if ((pxcor = 2) and (pycor = -8))  [ set pcolor orange set probability 3]
    if ((pxcor = 4) and (pycor = -8))  [ set pcolor yellow set probability 5]
    if ((pxcor = 6) and (pycor = -8))  [ set pcolor green set probability 0]
    if ((pxcor = 8) and (pycor = -8))  [ set pcolor orange set probability 4]
